...
function Sidebar({ isSidebarOpen, sidebarOpen }) {
  return !sidebarOpen ? (
    <div className="sidebar-comp bg-bgDark3 p-4 w-1/10 text-white">
      <button
        className="cursor-pointer px-1 rounded-md hover:bg-gray-500"
